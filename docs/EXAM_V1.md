...
2. **Link Kaggle:** [https://www.kaggle.com/competitions/datathon-2026-round-1](https://www.kaggle.com/competitions/datathon-2026-round-1)
3. **Báo cáo (Report):** Viết báo cáo sử dụng template LaTeX của NeurIPS (tối đa 4 trang).
4. **Link GitHub repository:** Chứa mã nguồn, notebook, và file submission (chế độ public).
5. **Form nộp bài thi Vòng 1:** Điền đầy đủ thông tin, upload PDF báo cáo và ảnh thẻ sinh viên.
