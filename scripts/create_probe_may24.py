...
PROBE_FILE = OUTPUT_DIR / "submission_probe_may24.csv"
...
if SAMPLE_SUB.exists():
    ...
    # Mask: May 2024
    may24_mask = (df['Date'] >= '2024-05-01') & (df['Date'] <= '2024-05-31')
    
    # Set probe values
    df['Revenue'] = 0.0
    df['COGS'] = 0.0
    df.loc[may24_mask, 'Revenue'] = C
    
    # Save
    df.to_csv(PROBE_FILE, index=False)
    
    n_days = may24_mask.sum()
    
    print(f"Probe for May 2024 created at: {PROBE_FILE}")
