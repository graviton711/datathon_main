...
PROBE_FILE = OUTPUT_DIR / "submission_probe_mar24.csv"
...
if SAMPLE_SUB.exists():
    ...
    # Mask: March 2024
    mar24_mask = (df['Date'] >= '2024-03-01') & (df['Date'] <= '2024-03-31')
    
    # Set probe values
    df['Revenue'] = 0.0
    df['COGS'] = 0.0
    df.loc[mar24_mask, 'Revenue'] = C
    
    # Save
    df.to_csv(PROBE_FILE, index=False)
    
    n_days = mar24_mask.sum()
    
    print(f"Probe for March 2024 created at: {PROBE_FILE}")
